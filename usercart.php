  ...
  while($r1=mysql_fetch_array($re))
   {
    ...
    $r2=mysql_fetch_array($re2);
     ?>
   <tr>
    <td><img width='100' height='100' src="img/<?php echo $r2['pic']?>" alt="" /></td>
...
<script type="text/javascript">
			function showMessage(){
				alert("Hi,Your product will deliverd in 1 hour.");
				window.location.href="userhome.php";

			}
		</script>
 <input type="submit" class='btn btn-primary 'name="submit" style="margin-top:5px; " value="submit" onClick='showMessage()' />
</body>
</html>